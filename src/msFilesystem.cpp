...
void msFilesystem::init() {
	msDevice::filesystem_ready_for_controller(this);
}

bool msFilesystem::begin(msDevice *pDrive, bool setCwv, uint8_t part) {
	_pDrive = pDrive;
	_part = part;
...
//Glue code...
bool msFilesystem::claim_partition(msDevice *controller, uint8_t part) {
